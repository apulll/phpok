...
<div class="table">
	...
	<div class="content">
		...
		<tr>
			...
			<td><label><input type="radio" name="etype" value="simple"<?php if($rs['etype'] == 'simple' || !$rs['etype']){ ?> checked<?php } ?> />精简编辑器</label></td>
		</tr>
		</table>
	</div>
</div>
<div class="table">
	...
	<div class="content">
		<ul class="layout">
			...
			<li><label><input type="checkbox" name="paste_text" id="paste_text"<?php if($rs['paste_text']){ ?> checked<?php } ?>>纯文本粘贴</label></li>
			<li><label><input type="checkbox" name="inc_tag" id="inc_tag"<?php if($rs['inc_tag']){ ?> checked<?php } ?>>Tag标签信息格式化到内容</label></li>
		</ul>
		<div class="clear"></div>
	</div>
</div>
<div class="table">
	...
	<div class="content">
		<ul class="layout">
			...
			<li><label><input type="checkbox" name="btn_video" id="btn_video"<?php if($rs['btn_video']){ ?> checked<?php } ?>>视频</label></li>
