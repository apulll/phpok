		...
		<div class="pfw">
			...
			<div class="detail">
				...
				<ul class="pictures">
					...
					<li>
						<div class="img"><a href="<?php echo $value['gd']['auto'];?>" target="_blank"><img src="images/blank.gif" _src="<?php echo $value['gd']['auto'];?>" border="0" alt="<?php echo $value['title'];?>" /></a></div>
						<?php if($value['note']){ ?>
						<div class="content"><?php echo $value['note'];?></div>
						<?php } ?>
					</li>
					<?php } ?>
				</ul>
				<div class="pn">
					<a href="javascript:void(0);" class="prev">上一张</a> (点击图片在新窗口查看原图) <a href="javascript:void(0);" class="next">下一张</a>
				</div>
				</div>
